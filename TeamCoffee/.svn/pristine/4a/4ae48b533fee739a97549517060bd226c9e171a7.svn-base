...
<script src="/resources/js/owner/order_confirm.js?ver=71" type="text/javascript"></script>
<style type="text/css">
.table th{
	text-align: center;
}
			...
			<div class="col">
				...
				<div class="row justify-content-center">
					<div class="col text-center">
						...
						<input type="button" value="검색" class="btn btn-primary btn-sm" id="searchDateBtn" onclick="searchDateBtn();">
					</div>
				</div>
				<div class="row justify-content-center">
					<div class="col text-center">
