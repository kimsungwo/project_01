...
.meunOptionGroupTypeSwitch .custom-control-input:checked~.custom-control-label::before {
    color: #fff;
    border-color: #343a40;
    background-color: #343a40;
}
</style>
<script src="/resources/js/owner/option_manage.js?ver=54" type="text/javascript"></script>
</head>
<body>
<div class="container">
	<h1>옵션관리</h1>
	<p class="subMenuInfo">옵션을 추가해서 등록 및 편집이 가능합니다</p>
	<p class="subMenuInfo">현재 선택된 옵션그룹은 <span>${optionGroupType.menuOptionGroupName }</span>입니다</p>
	<div class="row justify-content-center">
		<div class="col-10">
			<div class="row">
				<div class="col-6">
					<div class="custom-control custom-switch meunOptionGroupTypeSwitch">
							...
							<c:forEach items="${optionList }" var="optionInfo">
								<tr>
									<td>
										...
										<h6>
											<fmt:formatNumber value="${optionInfo.menuOptionPrice }" type="number"></fmt:formatNumber>원
										</h6>
									</td>
