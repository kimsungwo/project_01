...
<!-- js -->
<script src="/resources/js/owner/reg_cafe.js?ver=49" type="text/javascript"></script>
<!-- validation -->
...
<div class="container">
	<h1>매장등록</h1>
	<p class="subMenuInfo">매장을 등록 해 주세요.</p>
	...
	<input type="hidden" id="Longitude" name="cafeLongitude">
		<table class="table table-bordered regCafeTable">
			<colgroup>
				<col width="30%">
				<col width="*">
			</colgroup>
					...
					<td>
						<div class="row form-inline">
							 <div class="col-md-2">
		   					 ...
		   					 <div class="col-md-1 offset-1 text-center">~</div>
		   					 <div class="col-md-2">
