...
<script src="/resources/js/owner/cafe_manage.js?ver=2" type="text/javascript"></script>
</head>
<body>
<div class="container">
	<c:choose>
							...
							<div class="card-header" id="headingTwo">
								<h2 class="mb-0">
									<button class="btn btn-block text-left collapsed"
										...
										data-target="#collapse_${cafeInfo.cafeCode }" aria-expanded="false"
										aria-controls="collapseTwo">${cafeInfo.cafeName }
									</button>
								</h2>
							</div>
							<div id="collapse_${cafeInfo.cafeCode }" class="collapse"
