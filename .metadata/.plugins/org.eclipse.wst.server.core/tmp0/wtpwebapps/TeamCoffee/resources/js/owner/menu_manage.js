...
(function($){
               ...
               if(result == null || result == ''){
            	   ...
            	   $(result).each(function(i){
            		   ...
            		   if(result[i].menuImgName == 'no_image'){
            			   ...
            			   str += '<td><img src="/resources/img/menu/' + result[i].menuImgName + '" class="menuImg"></td>';
            		   }
		...
		$.ajax({
            ...
            success: function(result) {
               //ajax 실행 성공 후 실행할 코드 작성
            	...
            	$('#menuImg').attr('src', '/resources/img/menu/' + result.menuImgName);
	...
	/*hideNoImg = function(){
		$('.menuImg').each(function(){
			...
			alert(imgName);
			if(imgName == '/resources/img/menu/no_image'){
