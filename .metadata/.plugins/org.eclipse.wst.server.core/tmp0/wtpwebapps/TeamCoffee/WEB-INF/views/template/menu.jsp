			...
			<div class="modal-content">
				...
				<form action="#" method="post" class="needs-validation" novalidate id="loginForm">
					<div class="modal-body">
						...
						<div class="form-group form-check">
							<div class="loginBox">
								...
								<span id="loginLabel">로그인 유지</span>
							</div>
							<div class="custom-control custom-switch typeSwitch">
								<span id="typeSwitchSpan">매장주이신가요?</span>
					...
					<div class="modal-footer forgotDiv">
						<div>
							<a class="form-text text-muted" onclick="location.href='/member/find_idForm';" id="forgotId">아이디 찾기</a> |
							<a class="form-text text-muted"onclick="location.href='/member/find_pwForm';" id="forgotPw">비밀번호 찾기</a><br>
						</div>
