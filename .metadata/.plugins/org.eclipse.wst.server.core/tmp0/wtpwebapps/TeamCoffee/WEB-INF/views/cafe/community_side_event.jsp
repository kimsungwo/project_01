			...
			<div class="col">
				<div class="card">
					...
					<div class="card-body" align="center">
						<h5 class="card-title"><a href="/board/boardDetail?boardNum=${event.boardNum}&&boardCode=${event.boardCode}">${event.boardName }</a></h5>
	...
	<div id="btnDiv" align="center">
		<c:choose>
			<c:when test="${not empty sessionScope.ownerLoginInfo and sessionScope.ownerLoginInfo.ownerId eq 'admin'}">
				<input type="button" class="btn btn-secondary" value="글쓰기" onclick="location.href='/board/boardWriteForm?boardCode=BOARD_3'">
			</c:when>
