			...
			<ul class="navbar-nav mr-auto">
				<c:choose>
					<c:when test="${not empty sessionScope.ownerLoginInfo and sessionScope.ownerLoginInfo.isAdmin eq 'Y' }">
						...
						<li class="nav-item"><a class="nav-link" href="/owner/admin">My Page(관리자)</a></li>
					</c:when>
					<c:when test="${not empty sessionScope.ownerLoginInfo }">
						<li class="nav-item nav-link active">${sessionScope.ownerLoginInfo.ownerName }님 반갑습니다</li>
						<li class="nav-item"><a class="nav-link" href="/owner/main">My Page(매장주)</a></li>
					</c:when>
			...
			<div class="modal-content">
				...
				<form action="#" method="post" class="needs-validation" novalidate id="loginForm">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-outline-dark" onclick="location.href='/member/find_idForm';">일반회원 아이디 찾기</button>
						<button type="button" class="btn btn-outline-dark" onclick="location.href='/member/find_pwForm';">일반회원 비밀번호 찾기</button>
						<button type="button" class="btn btn-outline-dark" onclick="location.href='/owner/find_idForm';">매장주 아이디 찾기</button>
						<button type="button" class="btn btn-outline-dark" onclick="location.href='/owner/find_pwForm';">매장주 비밀번호 찾기</button>
					</div>
				</form>
			</div>
		</div>
