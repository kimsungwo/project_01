...
<div class="row">
	<div class="col">
		<div class="list-group">
			...
			<a href="#" class="list-group-item list-group-item-action <c:if test="${sideMenu eq 6 }">active</c:if>">예약확인</a>
			<a href="/owner/toDropOutForm" class="list-group-item list-group-item-action <c:if test="${sideMenu eq 7 }">active</c:if>">회원탈퇴</a>  
		</div>
	</div>
</div>
</body>
