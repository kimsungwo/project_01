...
<div class="row">
	<div class="col">
		<div class="list-group">
			...
			<c:if test="${sessionScope.ownerLoginInfo.isAdmin eq 'N'}">
			...
			<a href="/admin/memberManage" class="list-group-item list-group-item-action <c:if test="${sideMenu eq 6}">active</c:if>">멤버관리</a> 
			<%-- </c:if> --%>
		</div>
	</div>
</div>
